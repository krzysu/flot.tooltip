...
(function ($) {
    ...
    function init(plot) {
		...
		plot.hooks.bindEvents.push(function (plot, eventHolder) {
            ...
            if(opts.tooltipOpts.seriesEnabled == true) {
              tipText = opts.tooltipOpts.seriesPrefix + item.series.label + " " + opts.tooltipOpts.xValText + timestampToDate(item.datapoint[0]) + " " + opts.tooltipOpts.yValText + item.datapoint[1];
            }
            else {
            ...
            if(opts.tooltipOpts.seriesEnabled == true) {
              tipText =  opts.tooltipOpts.seriesPrefix + item.series.label + " " + opts.tooltipOpts.xValText + item.datapoint[0] + " " + opts.tooltipOpts.yValText + item.datapoint[1];
            }
            else {
